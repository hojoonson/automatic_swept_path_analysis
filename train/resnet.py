...
# Load data.
train_label="Pantechnicon_Removals_Van_trainlabels.txt"
traindata_path="./trainlabels/"+train_label
test_label="Pantechnicon_Removals_Van_testlabels.txt"
testdata_path="./testlabels/"+test_label
...
for element in testdata:
    ...
    print(resized.shape)
    x_test+=[resized]
    y_test+=[np.array([int(element.split(" ")[1])])]
f.close()
x_test=np.array(x_test)
y_test=np.array(y_test)


f = open("labelling_result_"+train_label, 'w+')
